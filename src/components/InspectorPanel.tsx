                ...
                >
                    ...
                    <div className="flex items-start justify-between p-6 pb-4 border-b border-accent/10">
                        <div className="flex-1 min-w-0">
                            {/* Breadcrumb — shown for child project nodes */}
                            {isChild ? (
                                <button
                        ...
                        <button
                            onClick={onClose}
                            className="p-1.5 rounded text-muted hover:text-text transition-colors mt-0.5 ml-3 shrink-0"
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-6">
                        ...
                        {/* Tech stack */}
                        {'tech' in node && node.tech && node.tech.length > 0 && (
                            <div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {(links?.github || childNode.links?.github) && (
                                        <a href={links?.github || childNode.links?.github}
                                            target="_blank" rel="noreferrer"
                                            className="flex items-center gap-1.5 px-3 py-1.5 rounded text-sm font-mono transition-colors text-muted hover:text-accent"
                                            style={{ background: 'rgba(61,227,255,0.06)', border: '1px solid rgba(61,227,255,0.15)' }}>
                                            <Github size={13} /> GitHub
                                        </a>
                                    )}
                                    {(links?.demo || childNode.links?.demo) && (
                                        <a href={links?.demo || childNode.links?.demo}
                                            target="_blank" rel="noreferrer"
                                            className="flex items-center gap-1.5 px-3 py-1.5 rounded text-sm font-mono transition-colors text-muted hover:text-accent"
                                            style={{ background: 'rgba(61,227,255,0.06)', border: '1px solid rgba(61,227,255,0.15)' }}>
